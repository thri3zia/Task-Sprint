        ...
        <form>
            <div className="m-6">
                ...
                <div className="relative mt-5">
                    <input type="text" id="name" onKeyUp={(e) => setName((e.target as HTMLInputElement).value)} className="block px-2.5 pb-1.5 pt-4 w-80 text-sm text-gray-900 bg-transparent rounded-lg border-2  appearance-none dark:text-white dark:border-gray-950y-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
